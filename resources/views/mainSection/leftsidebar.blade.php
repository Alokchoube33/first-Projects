        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a herf="layouts-light-sidebar.html" key="t-light-sidebar">Light Sidebar</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ url('/getform') }}"  key="t-form-elements">Form Elements</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="tables-zbasic.blade.php" key="t-basic-tables">ManageCustomers</a></li>
                        ...
                        <li><a href="{{url('/list')}}" key="t-editable-table">Editable Table</a></li>
